...
public class QBP537CC {
	...
	public QBP537CC(String hexString, String charString) throws Exception {
		...
		Integer dealCntr   = Integer.parseInt(dealCntrTxt);
	...
	private String dtlRec(String dataHex, String dataChar) {
		...
		fileFieldList.add(new FileField("l10-QBP537-itemCodeOrd",          itemCodeOrd,     "S9(7) COMP-3", 132, 135));
		fileFieldList.add(new FileField("l10-QBP537-itemChkDigitOrd",      itemChkDigitOrd, "S9 COMP-3",    136, 136));
		...
		fileFieldList.add(new FileField("l10-QBP537-ITEM-bioEng", bioEng, "X(1)", 211, 211));
		fileFieldList.add(new FileField("l10-QBP537-ITEM-tprFl",  tprFl,  "X(1)", 212, 212));
	...
	private String shpRec(String dataHex, String dataChar) {
		...
		String bioEng = subString(dataChar, 1);
		String tprFl = subString(dataChar, 1);
		fileFieldList.add(new FileField("l10-QBP537-SHIPPER-bioEng", bioEng, "X(1)", 167, 167));
		fileFieldList.add(new FileField("l10-QBP537-SHIPPER-tprFl",  tprFl,  "X(1)", 168, 168));
	...
	private String dealRecArea(String dataHex, String dataChar) {
		...
		Integer curIndex = currentIndex.intValue();
