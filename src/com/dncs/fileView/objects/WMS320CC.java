...
public class WMS320CC {
    ...
    public WMS320CC(String hexString, String charString, Integer recNum) throws Exception {
        super();
        ...
        frValue.append("").append(WMS320_ADVANCE_DAYS_THRHOLD);	//col 441-442 S9(3,0) COMP-3
        frValue.append("  / ").append(WMS320_DAYS_AVAIL_SHIP);		//col 426-428 S9(5,0) COMP-3
        frValue.append("  / ").append(WMS320_SELL_BY_DT_BEFORE_EXP);	//col 429-436 PIC X(08)
        frValue.append("  / ").append(WMS320_UNIT_QTY);				//col  35- 38 S9(7,0) COMP-3
        frValue.append("  / ").append(WMS320_AVG_WKLY_MVMT);			//col 418-421 S9(7,0) COMP-3
